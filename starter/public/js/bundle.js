      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', 'Session recieved successfully');
            console.log(session);
            console.log(stripe); //2) Create checkout form + charge Credit card

            console.log(Date.now()); // const id = session.data.session.id;
            // console.log(id);
...
console.log(bookBtn); //DELEGATION
// if (mapBox) {
