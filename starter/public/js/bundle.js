...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW1pbGJjYWhhdCIsImEiOiJjbDV2cjkyOXIwY2h3M2JtaTMxemtjM3FmIn0.JWn8DiZcQKCoUokTKNt7kw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/amilbcahat/cl5vrcqi4000314og9yv7s6om',
    scrollZoom: false // center: [78.08107, 27.909486],
    // zoom: 10,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend Map bounds to include the current location
...
var stripe = Stripe('pk_test_51LchTFSIIsKwTqRTywPx79my2AhIhWDKLmpWpCuujGWVMO2OCFUenbgdaVla5YRt9Kh1BJKIE2AdMSnUMMUXD9AS00qBIrMyPd');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', 'Redirecting to Payment Gateway...'); // console.log(session);
            // console.log(stripe);
...
var bookBtn = document.getElementById('book-tour'); // console.log(bookBtn);
//DELEGATION
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.preventDefault(); // console.log('button clicked 3');
